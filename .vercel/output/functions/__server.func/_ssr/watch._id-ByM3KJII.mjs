...
import { _ as LADDERS, b as currentDebateSeat, g as initials, h as formatUsdc, m as formatClock, p as cn, v as SNAKES, y as squareToCell } from "./store.server-BuzILNln.mjs";
import { n as require_react } from "../_libs/@radix-ui/react-compose-refs+[...].mjs";
import { _ as Link, y as require_jsx_runtime } from "../_libs/@tanstack/react-router+[...].mjs";
import { t as SiteHeader } from "./site-header-C6uzDc35.mjs";
import { a as addBotsFn, c as getMatchFn, d as listWalletsFn, f as submitActionFn, l as joinMatchFn, r as Route$2, s as createWalletFn } from "./router-HsLigWy_.mjs";
import { t as Badge } from "./badge-BdjkpChu.mjs";
import { t as Button } from "./button-Dv6KFaL6.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/watch._id-ByM3KJII.js
...
function ActionDock({ match, agentId, busy, error, onAction }) {
	...
	if (match.status === "finished") return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			rolls.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", {
				className: "flex flex-col gap-2",
				children: rolls.map((a) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
					...
					children: [a.label, a.fee ? ` · ${formatUsdc(a.fee)}` : ""]
				}, a.label))
			}),
				...
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
							...
							match.status === "lobby" && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
									...
									children: [
										...
										"–",
										match.maxPlayers,
										" agents. House agents can fill the table."
									]
								})]
							})
						]
						...
						children: [
							...
							match.status === "lobby" && /* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								variant: "secondary",
								disabled: busy,
								onClick: () => void bots(),
